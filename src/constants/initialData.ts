import { CardConfig, MadrasahInfo, Student, PageLoaderConfig, KopSuratConfig } from '../types';

export const INITIAL_KOP_SURAT_CONFIG: KopSuratConfig = {
  baris1Kementerian: 'KEMENTERIAN AGAMA REPUBLIK INDONESIA',
  showBaris1: true,
  isUppercaseBaris1: true,
  fontSizeBaris1: 13,

  baris2Wilayah: 'KANTOR KEMENTERIAN AGAMA KABUPATEN BANYUMAS',
  showBaris2: true,
  isUppercaseBaris2: true,
  fontSizeBaris2: 14,

  baris3Madrasah: "MI MA'ARIF NU 2 SANGGREMAN",
  showBaris3: true,
  isUppercaseBaris3: true,
  fontSizeBaris3: 17,

  baris4Legalitas: 'NSM: 111233020050 • NPSN: 60710255 • Terakreditasi A',
  showBaris4: true,
  fontSizeBaris4: 10.5,

  baris5Alamat: 'Jl. Sanggreman No. 02, Desa Sanggreman, Kec. Rawalo, Kab. Banyumas, Jawa Tengah 53173',
  showBaris5: true,
  fontSizeBaris5: 9.5,

  baris6Kontak: 'Telp: (0281) 684-1234 | Email: mimaarifnu2sanggreman@gmail.com | Website: www.mimaarifnu2sanggreman.sch.id',
  showBaris6: true,
  fontSizeBaris6: 9,

  layoutPreset: 'dua-logo',
  showLogoKiri: true,
  logoKiriUrl: '',
  logoKiriSize: 76,
  showLogoKanan: true,
